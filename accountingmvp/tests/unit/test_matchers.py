...
from src.reconciliation.matchers import FuzzyTextMatcher, AmountMatcher, DateMatcher
...
class TestFuzzyTextMatcher:
    ...
    def test_exact_match_returns_high_score(self):
        ...
        t2 = NormalizedTransaction(
            ...
            description="Payment from ABC Corp", source="ecocash"
        )
    ...
    def test_similar_text_returns_good_score(self):
        ...
        t1 = NormalizedTransaction(
            id="1", transaction_date=date(2024, 1, 1),
            amount=Decimal("100"), reference="REF1",
            description="Payment from ABC Corporation", source="bank"
        )
        t2 = NormalizedTransaction(
            id="2", transaction_date=date(2024, 1, 1),
            amount=Decimal("100"), reference="REF2",
            description="ABC Corp payment received", source="ecocash"
        )
...
class TestAmountMatcher:
    ...
    def test_exact_amount_returns_perfect_score(self):
        ...
        t1 = NormalizedTransaction(
            id="1", transaction_date=date(2024, 1, 1),
            amount=Decimal("1500.00"), reference="REF1",
            description="Test", source="bank"
        )
        t2 = NormalizedTransaction(
            id="2", transaction_date=date(2024, 1, 1),
            amount=Decimal("1500.00"), reference="REF2",
            description="Test", source="ecocash"
        )
    ...
    def test_within_tolerance_returns_high_score(self):
        ...
        t2 = NormalizedTransaction(
            id="2", transaction_date=date(2024, 1, 1),
            amount=Decimal("1510.00"), reference="REF2",
            description="Test", source="ecocash"
        )
    ...
    def test_different_amount_returns_low_score(self):
        ...
        t2 = NormalizedTransaction(
            id="2", transaction_date=date(2024, 1, 1),
            amount=Decimal("500.00"), reference="REF2",
            description="Test", source="ecocash"
        )
...
class TestDateMatcher:
    ...
    def test_same_date_returns_perfect_score(self):
        ...
        t2 = NormalizedTransaction(
            id="2", transaction_date=date(2024, 1, 15),
            amount=Decimal("100"), reference="REF2",
            description="Test", source="ecocash"
        )
    ...
    def test_within_window_returns_good_score(self):
        ...
        t2 = NormalizedTransaction(
            id="2", transaction_date=date(2024, 1, 17),
            amount=Decimal("100"), reference="REF2",
            description="Test", source="ecocash"
        )
    ...
    def test_outside_window_returns_zero(self):
        ...
        t2 = NormalizedTransaction(
            id="2", transaction_date=date(2024, 1, 25),
            amount=Decimal("100"), reference="REF2",
            description="Test", source="ecocash"
        )
